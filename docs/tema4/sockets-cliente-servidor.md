...
El caso concreto que vas a construir en las próximas dos semanas: un panel de actividad en vivo de tu aplicación, donde el servidor empuja cada evento del catálogo (crear, actualizar, borrar un libro) hacia los clientes conectados, en el instante en que ocurre — sin que ellos tengan que preguntar.
