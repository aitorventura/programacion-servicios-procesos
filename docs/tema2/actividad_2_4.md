...
Tu GameVault ya no reenvía credenciales en cada petición. La semana que viene completas la política de rutas y añades tests automatizados de seguridad y tests automatizados de seguridad.
